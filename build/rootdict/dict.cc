...
#include "/home/goto/ILC/LCFIPlus/include/makerootfileforDL.h"
...
namespace ROOT {
   static void *new_lcfipluscLcLVertexFindingwithDL(void *p = 0);
   static void *newArray_lcfipluscLcLVertexFindingwithDL(Long_t size, void *p);
   static void delete_lcfipluscLcLVertexFindingwithDL(void *p);
   static void deleteArray_lcfipluscLcLVertexFindingwithDL(void *p);
   static void destruct_lcfipluscLcLVertexFindingwithDL(void *p);
   static void streamer_lcfipluscLcLVertexFindingwithDL(TBuffer &buf, void *obj);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::lcfiplus::VertexFindingwithDL*)
   {
      ::lcfiplus::VertexFindingwithDL *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::lcfiplus::VertexFindingwithDL >(0);
      static ::ROOT::TGenericClassInfo 
         instance("lcfiplus::VertexFindingwithDL", ::lcfiplus::VertexFindingwithDL::Class_Version(), "include/processwithDL.h", 19,
                  typeid(::lcfiplus::VertexFindingwithDL), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::lcfiplus::VertexFindingwithDL::Dictionary, isa_proxy, 16,
                  sizeof(::lcfiplus::VertexFindingwithDL) );
      instance.SetNew(&new_lcfipluscLcLVertexFindingwithDL);
      instance.SetNewArray(&newArray_lcfipluscLcLVertexFindingwithDL);
      instance.SetDelete(&delete_lcfipluscLcLVertexFindingwithDL);
      instance.SetDeleteArray(&deleteArray_lcfipluscLcLVertexFindingwithDL);
      instance.SetDestructor(&destruct_lcfipluscLcLVertexFindingwithDL);
      instance.SetStreamerFunc(&streamer_lcfipluscLcLVertexFindingwithDL);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::lcfiplus::VertexFindingwithDL*)
   {
      return GenerateInitInstanceLocal((::lcfiplus::VertexFindingwithDL*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::lcfiplus::VertexFindingwithDL*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT

namespace ROOT {
   static void *new_lcfipluscLcLMakeROOTFileCC(void *p = 0);
   static void *newArray_lcfipluscLcLMakeROOTFileCC(Long_t size, void *p);
   static void delete_lcfipluscLcLMakeROOTFileCC(void *p);
   static void deleteArray_lcfipluscLcLMakeROOTFileCC(void *p);
   static void destruct_lcfipluscLcLMakeROOTFileCC(void *p);
   static void streamer_lcfipluscLcLMakeROOTFileCC(TBuffer &buf, void *obj);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::lcfiplus::MakeROOTFileCC*)
   {
      ::lcfiplus::MakeROOTFileCC *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::lcfiplus::MakeROOTFileCC >(0);
      static ::ROOT::TGenericClassInfo 
         instance("lcfiplus::MakeROOTFileCC", ::lcfiplus::MakeROOTFileCC::Class_Version(), "include/makerootfileforDL.h", 16,
                  typeid(::lcfiplus::MakeROOTFileCC), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::lcfiplus::MakeROOTFileCC::Dictionary, isa_proxy, 16,
                  sizeof(::lcfiplus::MakeROOTFileCC) );
      instance.SetNew(&new_lcfipluscLcLMakeROOTFileCC);
      instance.SetNewArray(&newArray_lcfipluscLcLMakeROOTFileCC);
      instance.SetDelete(&delete_lcfipluscLcLMakeROOTFileCC);
      instance.SetDeleteArray(&deleteArray_lcfipluscLcLMakeROOTFileCC);
      instance.SetDestructor(&destruct_lcfipluscLcLMakeROOTFileCC);
      instance.SetStreamerFunc(&streamer_lcfipluscLcLMakeROOTFileCC);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::lcfiplus::MakeROOTFileCC*)
   {
      return GenerateInitInstanceLocal((::lcfiplus::MakeROOTFileCC*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::lcfiplus::MakeROOTFileCC*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT

namespace ROOT {
   static void *new_lcfipluscLcLMakeROOTFileBB(void *p = 0);
   static void *newArray_lcfipluscLcLMakeROOTFileBB(Long_t size, void *p);
   static void delete_lcfipluscLcLMakeROOTFileBB(void *p);
   static void deleteArray_lcfipluscLcLMakeROOTFileBB(void *p);
   static void destruct_lcfipluscLcLMakeROOTFileBB(void *p);
   static void streamer_lcfipluscLcLMakeROOTFileBB(TBuffer &buf, void *obj);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::lcfiplus::MakeROOTFileBB*)
   {
      ::lcfiplus::MakeROOTFileBB *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::lcfiplus::MakeROOTFileBB >(0);
      static ::ROOT::TGenericClassInfo 
         instance("lcfiplus::MakeROOTFileBB", ::lcfiplus::MakeROOTFileBB::Class_Version(), "include/makerootfileforDL.h", 130,
                  typeid(::lcfiplus::MakeROOTFileBB), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::lcfiplus::MakeROOTFileBB::Dictionary, isa_proxy, 16,
                  sizeof(::lcfiplus::MakeROOTFileBB) );
      instance.SetNew(&new_lcfipluscLcLMakeROOTFileBB);
      instance.SetNewArray(&newArray_lcfipluscLcLMakeROOTFileBB);
      instance.SetDelete(&delete_lcfipluscLcLMakeROOTFileBB);
      instance.SetDeleteArray(&deleteArray_lcfipluscLcLMakeROOTFileBB);
      instance.SetDestructor(&destruct_lcfipluscLcLMakeROOTFileBB);
      instance.SetStreamerFunc(&streamer_lcfipluscLcLMakeROOTFileBB);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::lcfiplus::MakeROOTFileBB*)
   {
      return GenerateInitInstanceLocal((::lcfiplus::MakeROOTFileBB*)0);
   }
   // Static variable to force the class initialization
...
namespace lcfiplus {
//______________________________________________________________________________
atomic_TClass_ptr VertexFindingwithDL::fgIsA(0);  // static to hold class pointer

//______________________________________________________________________________
const char *VertexFindingwithDL::Class_Name()
{
   return "lcfiplus::VertexFindingwithDL";
}

//______________________________________________________________________________
const char *VertexFindingwithDL::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::lcfiplus::VertexFindingwithDL*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int VertexFindingwithDL::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::lcfiplus::VertexFindingwithDL*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *VertexFindingwithDL::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::lcfiplus::VertexFindingwithDL*)0x0)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *VertexFindingwithDL::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::lcfiplus::VertexFindingwithDL*)0x0)->GetClass(); }
   return fgIsA;
}
...
namespace lcfiplus {
//______________________________________________________________________________
atomic_TClass_ptr MakeROOTFileCC::fgIsA(0);  // static to hold class pointer

//______________________________________________________________________________
const char *MakeROOTFileCC::Class_Name()
{
   return "lcfiplus::MakeROOTFileCC";
}

//______________________________________________________________________________
const char *MakeROOTFileCC::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::lcfiplus::MakeROOTFileCC*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int MakeROOTFileCC::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::lcfiplus::MakeROOTFileCC*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *MakeROOTFileCC::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::lcfiplus::MakeROOTFileCC*)0x0)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *MakeROOTFileCC::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::lcfiplus::MakeROOTFileCC*)0x0)->GetClass(); }
   return fgIsA;
}
...
namespace lcfiplus {
//______________________________________________________________________________
atomic_TClass_ptr MakeROOTFileBB::fgIsA(0);  // static to hold class pointer

//______________________________________________________________________________
const char *MakeROOTFileBB::Class_Name()
{
   return "lcfiplus::MakeROOTFileBB";
}

//______________________________________________________________________________
const char *MakeROOTFileBB::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::lcfiplus::MakeROOTFileBB*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int MakeROOTFileBB::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::lcfiplus::MakeROOTFileBB*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *MakeROOTFileBB::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::lcfiplus::MakeROOTFileBB*)0x0)->GetClass();
   return fgIsA;
}
...
namespace lcfiplus {
//______________________________________________________________________________
void VertexFindingwithDL::Streamer(TBuffer &R__b)
{
   // Stream an object of class lcfiplus::VertexFindingwithDL.

   //This works around a msvc bug and should be harmless on other platforms
   typedef ::lcfiplus::VertexFindingwithDL thisClass;
   UInt_t R__s, R__c;
   if (R__b.IsReading()) {
      Version_t R__v = R__b.ReadVersion(&R__s, &R__c); if (R__v) { }
      //This works around a msvc bug and should be harmless on other platforms
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_lcfipluscLcLVertexFindingwithDL(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) ::lcfiplus::VertexFindingwithDL : new ::lcfiplus::VertexFindingwithDL;
   }
   static void *newArray_lcfipluscLcLVertexFindingwithDL(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) ::lcfiplus::VertexFindingwithDL[nElements] : new ::lcfiplus::VertexFindingwithDL[nElements];
   }
   // Wrapper around operator delete
   static void delete_lcfipluscLcLVertexFindingwithDL(void *p) {
      delete ((::lcfiplus::VertexFindingwithDL*)p);
   }
   static void deleteArray_lcfipluscLcLVertexFindingwithDL(void *p) {
      delete [] ((::lcfiplus::VertexFindingwithDL*)p);
   }
   static void destruct_lcfipluscLcLVertexFindingwithDL(void *p) {
      typedef ::lcfiplus::VertexFindingwithDL current_t;
      ((current_t*)p)->~current_t();
   }
   // Wrapper around a custom streamer member function.
   static void streamer_lcfipluscLcLVertexFindingwithDL(TBuffer &buf, void *obj) {
      ((::lcfiplus::VertexFindingwithDL*)obj)->::lcfiplus::VertexFindingwithDL::Streamer(buf);
   }
} // end of namespace ROOT for class ::lcfiplus::VertexFindingwithDL

namespace lcfiplus {
//______________________________________________________________________________
void MakeROOTFileCC::Streamer(TBuffer &R__b)
{
   // Stream an object of class lcfiplus::MakeROOTFileCC.

   //This works around a msvc bug and should be harmless on other platforms
   typedef ::lcfiplus::MakeROOTFileCC thisClass;
   UInt_t R__s, R__c;
   if (R__b.IsReading()) {
      Version_t R__v = R__b.ReadVersion(&R__s, &R__c); if (R__v) { }
      //This works around a msvc bug and should be harmless on other platforms
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_lcfipluscLcLMakeROOTFileCC(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) ::lcfiplus::MakeROOTFileCC : new ::lcfiplus::MakeROOTFileCC;
   }
   static void *newArray_lcfipluscLcLMakeROOTFileCC(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) ::lcfiplus::MakeROOTFileCC[nElements] : new ::lcfiplus::MakeROOTFileCC[nElements];
   }
   // Wrapper around operator delete
   static void delete_lcfipluscLcLMakeROOTFileCC(void *p) {
      delete ((::lcfiplus::MakeROOTFileCC*)p);
   }
   static void deleteArray_lcfipluscLcLMakeROOTFileCC(void *p) {
      delete [] ((::lcfiplus::MakeROOTFileCC*)p);
   }
   static void destruct_lcfipluscLcLMakeROOTFileCC(void *p) {
      typedef ::lcfiplus::MakeROOTFileCC current_t;
      ((current_t*)p)->~current_t();
   }
   // Wrapper around a custom streamer member function.
   static void streamer_lcfipluscLcLMakeROOTFileCC(TBuffer &buf, void *obj) {
      ((::lcfiplus::MakeROOTFileCC*)obj)->::lcfiplus::MakeROOTFileCC::Streamer(buf);
   }
} // end of namespace ROOT for class ::lcfiplus::MakeROOTFileCC

namespace lcfiplus {
//______________________________________________________________________________
void MakeROOTFileBB::Streamer(TBuffer &R__b)
{
   // Stream an object of class lcfiplus::MakeROOTFileBB.

   //This works around a msvc bug and should be harmless on other platforms
   typedef ::lcfiplus::MakeROOTFileBB thisClass;
   UInt_t R__s, R__c;
   if (R__b.IsReading()) {
      Version_t R__v = R__b.ReadVersion(&R__s, &R__c); if (R__v) { }
      //This works around a msvc bug and should be harmless on other platforms
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_lcfipluscLcLMakeROOTFileBB(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) ::lcfiplus::MakeROOTFileBB : new ::lcfiplus::MakeROOTFileBB;
   }
   static void *newArray_lcfipluscLcLMakeROOTFileBB(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) ::lcfiplus::MakeROOTFileBB[nElements] : new ::lcfiplus::MakeROOTFileBB[nElements];
   }
   // Wrapper around operator delete
   static void delete_lcfipluscLcLMakeROOTFileBB(void *p) {
      delete ((::lcfiplus::MakeROOTFileBB*)p);
   }
   static void deleteArray_lcfipluscLcLMakeROOTFileBB(void *p) {
      delete [] ((::lcfiplus::MakeROOTFileBB*)p);
   }
   static void destruct_lcfipluscLcLMakeROOTFileBB(void *p) {
      typedef ::lcfiplus::MakeROOTFileBB current_t;
      ((current_t*)p)->~current_t();
   }
   // Wrapper around a custom streamer member function.
   static void streamer_lcfipluscLcLMakeROOTFileBB(TBuffer &buf, void *obj) {
...
"/home/goto/ILC/LCFIPlus/include/lcfiplus.h",
"/home/goto/ILC/LCFIPlus/include/EventStore.h",
"/home/goto/ILC/LCFIPlus/include/LCIOStorer.h",
"/home/goto/ILC/LCFIPlus/include/TreeStorer.h",
"/home/goto/ILC/LCFIPlus/include/JetFinder.h",
"/home/goto/ILC/LCFIPlus/include/process.h",
"/home/goto/ILC/LCFIPlus/include/FlavorTag.h",
"/home/goto/ILC/LCFIPlus/include/MakeNtuple.h",
"/home/goto/ILC/LCFIPlus/include/TrainMVA.h",
"/home/goto/ILC/LCFIPlus/include/ReadMVA.h",
"/home/goto/ILC/LCFIPlus/include/testproc.h",
"/home/goto/ILC/LCFIPlus/include/TrackNtuple.h",
"/home/goto/ILC/LCFIPlus/include/VertexMassRecovery.h",
"/home/goto/ILC/LCFIPlus/include/VertexNtuple.h",
"/home/goto/ILC/LCFIPlus/include/processwithDL.h",
"/home/goto/ILC/LCFIPlus/include/makerootfileforDL.h",
0
    };
...
"/gluster/data/ilc/ilcsoft/v02-02/external_packages/root/6.18.04/include",
"/disk/ssd01/home_ssd01/goto/ILC/LCFIPlus/",
0
    };
...
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/lcfiplus.h")))  Track;}
namespace std{template <typename _Tp> class __attribute__((annotate("$clingAutoload$bits/allocator.h")))  __attribute__((annotate("$clingAutoload$string")))  allocator;
}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/lcfiplus.h")))  Neutral;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/lcfiplus.h")))  MCParticle;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/lcfiplus.h")))  MCColorSinglet;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/lcfiplus.h")))  Vertex;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/lcfiplus.h")))  Jet;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/lcfiplus.h")))  MCVertex;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/lcfiplus.h")))  EventStoreObserver;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/lcfiplus.h")))  EventStore;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/lcfiplus.h")))  Algorithm;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/LCIOStorer.h")))  LCIOStorer;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/TreeStorer.h")))  TreeStorer;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/process.h")))  PrimaryVertexFinder;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/process.h")))  BuildUpVertex;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/process.h")))  JetClustering;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/process.h")))  JetVertexRefiner;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/FlavorTag.h")))  FlavorTag;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/MakeNtuple.h")))  MakeNtuple;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/TrainMVA.h")))  TrainMVA;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/ReadMVA.h")))  ReadMVA;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/testproc.h")))  ZHHAlgo;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/testproc.h")))  TestAlgo;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/testproc.h")))  VertexAnalysis;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/testproc.h")))  FlavtagReader;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/testproc.h")))  TestAlgoV0;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/TrackNtuple.h")))  TrackNtuple;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/VertexMassRecovery.h")))  VertexMassRecovery;}
namespace lcfiplus{class __attribute__((annotate("$clingAutoload$/home/goto/ILC/LCFIPlus/include/VertexNtuple.h")))  VertexNtuple;}
...
"lcfiplus::VertexFindingwithDL", payloadCode, "@",
